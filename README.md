...
<tr>
   ...
   <tr>
    ...
    <tr>
        ...
        <td>
            HoneyLabs provides free per-IP reports built from its own honeypot network: the captured payloads, targeted ports and CVE signature matches, JA4, Akin and HASSH client fingerprints, and VirusTotal-verified malware the IP delivered. The data is queryable anonymously on the web, over a JSON API and via an <a href="https://github.com/honeylabshq/honeylabs-mcp" target="_blank">MCP server</a>, with open no-auth IOC feeds of active exploiters and malware infrastructure.
        </td>
    </tr>
    <tr>
        <td>
